...
BASE_URL = "https://api.glaw.site/ai"
...
TESTS = [
    ...
    },
    {
        ...
        "country_id": 2,
        "type": "정상",
        "query": "집주인이 갑자기 집에서 나가라고 하면 어떻게 해야 해?",
    },
    {
        "country": "캘리포니아",
        "country_id": 2,
        "type": "엣지",
        "query": "한국에서 운전면허를 땄는데 캘리포니아에서 운전해도 돼?",
    },
    {
        "country": "캘리포니아",
        "country_id": 2,
    ...
    # ── 캐나다 연방 ───────────────────────────────────────────
    {
        ...
        "country_id": 4,
        "type": "막연",
        "query": "이민 오면 어떻게 해야 해?",
    },
    {
        "country": "캐나다연방",
        "country_id": 4,
        "type": "정상",
        "query": "캐나다에서 대마초 합법이야?",
    },
    {
        "country": "캐나다연방",
        "country_id": 4,
        "type": "엣지",
        "query": "캘리포니아 법이랑 캐나다 법 중 뭐가 더 엄격해?",
    },
    # ── 온타리오 ─────────────────────────────────────────────
    {
        "country": "온타리오",
        "country_id": 5,
        "type": "막연",
        "query": "집 사면 어떤 세금 내야 해?",
    },
    {
        "country": "온타리오",
        "country_id": 5,
        "type": "정상",
        "query": "집주인이 보증금을 안 돌려주면 어떻게 해?",
    },
    # ── BC ───────────────────────────────────────────────────
    {
        "country": "BC",
        "country_id": 6,
        "type": "막연",
        "query": "사고 나면 어떻게 해야 해?",
    },
    {
        "country": "BC",
        "country_id": 6,
        "type": "정상",
        "query": "BC에서 음주운전 걸리면 면허 정지돼?",
    },
]
